                ...
                <div class="block full">
                    ...
                    <div class="table-responsive">
                        <table id="example-datatable" class="table table-striped table-bordered table-vcenter">
                            ...
                            <tbody>
                            <?php $no=0; foreach ($agm as $row): $no++?>
                                <tr>
                                    ...
                                    <td>
                                        <?php 
                                            if ($row['statt'] == 1) {$klas = "label label-info"; $tampil = "AKTIF";} 
                                    ...
                                    <td class="text-center">
                                        <a href="<?php echo base_url('editagama/'. $row['id_agama']) ; ?>" data-toggle="tooltip" title="Edit <?php echo $row['nama_agama']?>" class="btn btn-effect-ripple btn-success"><i class="fa fa-pencil"></i></a>
                                        <a onclick="return confirm('Apakah Anda Yakin Ingin Menghapus <?php echo $row['nama_agama'] ?> ?');" href="<?php echo base_url('deleteagama/'. $row['id_agama']) ; ?>" data-toggle="tooltip" title="Delete <?php echo $row['nama_agama']?>" class="btn btn-effect-ripple btn-danger"><i class="fa fa-times"></i></a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                            </tbody>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= base_url('storeagama') ?>" method="post" class="form-bordered">
